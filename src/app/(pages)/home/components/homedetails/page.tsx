      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          <motion.div whileHover={{ scale: 1.05 }} className=" bg-[#f0f0f0] rounded-lg shadow-md pb-4 ">
            ...
            <p className="mt-2 text-[#848484] px-4 pb-2">Bridging ambition with access.</p>
            <p className='text-[#848484] px-4'>We identify promising individuals from diverse and underrepresented communities and connect them with experienced leaders, mentors, and collaborators. This network of support provides the first step toward unlocking confidence, guidance, and opportunity.</p>
          </motion.div>
          <motion.div whileHover={{ scale: 1.05 }} className=" bg-[#f0f0f0] rounded-lg shadow-md pb-4 ">
            ...
            <p className="mt-2 text-[#848484] px-4 pb-2">Cultivating leadership through shared learning.
            </p>
            <p className='text-[#848484] px-4'>Through personalized mentorship, peer dialogue, and immersive exposure, we help youth build their knowledge, skills, and perspective. This nurturing ecosystem encourages critical thinking, resilience, and collaborative growth.
            </p>
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="bg-[#f0f0f0] rounded-lg shadow-md pb-4">
            ...
            <p className="mt-2 text-[#848484] px-4 pb-2">Shaping the changemakers of tomorrow.
            </p>
            <p className='text-[#848484] px-4'>Our programs are designed to develop socially conscious leaders who can drive positive change in their communities and beyond. We empower them to lead with empathy, innovation, and a sense of responsibility toward inclusive progress.</p>
          </motion.div>
        </div>
      </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6 ">
          {initiativesData.map((initiative, index) => (
            <motion.div key={index} whileHover={{ scale: 1.05 }} className=" bg-white rounded-lg shadow-md">
              ...
              <p className='text-[#848484] px-4 pb-2'>{initiative.desc.short}</p>
              <p className='text-[#848484] px-4 text-left'>{initiative.desc.full} </p>
            </motion.div>
          ))}
        </div>
      </motion.div>
...
>
  ...
  <p className="mt-6 text-lg text-[#848484] text-left">
